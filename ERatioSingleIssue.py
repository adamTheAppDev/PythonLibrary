...
LengthOfTest = range(2, 52) #(2,3) = 1 day Eratio // assuming fill on close
...
#Signal generation; if SMA is not calculated stay out of market
Asset['Regime'] = np.where(Asset['Adj Close'] < Asset['SMA'], -1, 1)
...
#Create dataframe and add edgeratio
