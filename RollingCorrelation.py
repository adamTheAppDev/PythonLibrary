...
s3 = pd.DataFrame()
s3['Correlation'] = pd.rolling_corr(s1['Adj Close'],s2['Adj Close'], window) #Correlation of price, pick this
#s3['Correlation'] = pd.rolling_corr(s1['LogRet'],s2['LogRet'], window) #Correlation of returns, or pick this
s3 = s3[window:]
